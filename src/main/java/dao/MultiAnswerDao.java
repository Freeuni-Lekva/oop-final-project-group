...
import models.MultiAnswerQuestion;
...
public class MultiAnswerDao extends AbstractQuestionDao {
    ...
    protected void insertAnswersIntoDB(int questionId, Question question, Connection connection) throws SQLException {
        ...
        Map<String, Boolean> options = multiAnswerQuestion.getOptions();
    ...
    protected Question createQuestionObject(int questionId, String questionText, Object answers, int quizId, int orderInQuiz){
        return new MultiAnswerQuestion(questionId, questionText, (Map<String, Boolean>)answers, quizId, orderInQuiz);
    }
